...
type IconName =
  | 'search' | 'cart' | 'close' | 'arrow-right' | 'arrow-left' | 'arrow-down'
  | 'delete' | 'add' | 'check' | 'menu' | 'file' | 'download' | 'share'
  | 'shield' | 'truck' | 'heart' | 'refresh'
  | 'globe' | 'email' | 'phone' | 'map'
...
const paths: Record<IconName, ReactElement> = {
  ...
  phone: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 3.07 9.8 19.79 19.79 0 0 1 .01 1.18a2 2 0 0 1 2-2.18h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.67 2.81a2 2 0 0 1-.45 2.11L6.91 7.91a16 16 0 0 0 6.14 6.14l1.27-1.27a2 2 0 0 1 2.11-.45c.91.31 1.85.54 2.81.67A2 2 0 0 1 22 16.92z" />
    </svg>
  ),
  map: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function Icon({ name, size = 'sm', className = '' }: Props) {
